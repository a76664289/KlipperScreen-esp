...
#   ESP32-JC4827W543C（ESP32-S3-WROOM-1，4.3" 480x272 QSPI ST3401A/NV3041A + GT911）
...
board_conf() {
    case "$1" in
        ...
        *) echo "unknown board: $1 (cyd_2432s028r | cyd_2432s028r_plus | JC4827W543C | ESP32-3248S035C | e32r35t | esp32s3-st7789-320_240-ec11 | esp32-st7735s-128_160-ec11 | esp32-st7789-320_240-ec11 | esp32-ILI9341-320_240-ec11 | esp32-ST7796-320_240-ec11 | esp32s3-st7796-480_320-xpt2046-ec11 | esp32s3-ILI9488-480_320-xpt2046-ec11 | esp32s3-ILI9341-320_240-xpt2046-ec11 | esp32c3-st7789-320_240-ec11 | jc8048w550 | esp32s3-JLC-SZP | esp32s3-retro-go | all)" >&2; exit 1 ;;
    esac
}
...
if [ "$BOARD" = all ]; then
    ...
    build_one JC4827W543C
    build_one ESP32-3248S035C
