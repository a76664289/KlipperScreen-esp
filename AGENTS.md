...
- 现有按钮：CYD / CYD-PLUS / E32R35T / JC8048 / esp32-st7735s-128_160-ec11 / esp32-st7789-320_240-ec11 = 板载 BOOT 键（GPIO0，低电平有效）；esp32s3-st7789-320_240-ec11（S3）/ esp32s3-st7796-480_320-xpt2046-ec11（S3）= BOOT（GPIO0）+ 外挂息屏按钮（GPIO39──按键──GND，内部上拉、低电平有效）；esp32c3-st7789-320_240-ec11（C3）= 板载 BOOT 键（GPIO9，低电平有效）。
