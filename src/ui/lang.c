...
static const dict_entry_t dict[] = {
    ...
    {"关于",            "About",               "關於",              "À propos",                  "Informazioni"},
    {"项目",            "Project",             "專案",              "Projet",                    "Progetto"},
    {"作者",            "Author",              "作者",              "Auteur",                    "Autore"},
    {"协议",            "License",             "授權協議",          "Licence",                   "Licenza"},
    {"框架",            "Framework",           "框架",              "Framework",                 "Framework"},
    {"板型",            "Board",               "板型",              "Carte",                     "Scheda"},
    ...
    {"编码器步进", "Encoder step", "編碼器步進", "Pas encodeur", "Passo encoder"},
    {"屏幕色序", "Color order", "螢幕色序", "Ordre couleurs", "Ordine colori"},
    {"色序", "Color", "色序", "Couleur", "Colore"},
    {"红", "red", "紅", "rouge", "rosso"},
    {"绿", "green", "綠", "vert", "verde"},
    {"蓝", "blue", "藍", "bleu", "blu"},
    {"默认", "Default", "預設", "Défaut", "Default"},
    {"恢复", "Revert", "還原", "Rétablir", "Ripristina"},
    {"转动测试: 每格移动一项\n%u 秒内确认\n否则自动恢复",
     "Turn: one item per click\nConfirm within %u s\nor revert automatically",
     "轉動測試: 每格移動一項\n%u 秒內確認\n否則自動還原",
     "Tournez : un cran par choix\nConfirmez sous %u s\nsinon retour automatique",
     "Ruota: una voce per scatto\nConferma entro %u s\no ripristino automatico"},
