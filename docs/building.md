...
Board names: `cyd_2432s028r` / `e32r35t` / `esp32s3-st7789-320_240-ec11` / `esp32-st7735s-128_160-ec11` / `esp32-st7789-320_240-ec11` / `esp32s3-st7796-480_320-xpt2046-ec11` / `jc8048w550` / `esp32s3-JLC-SZP`. Each board has its own build directory and sdkconfig (chip targets differ — never mix them).
